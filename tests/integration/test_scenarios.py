...
async def test_1_1_admin_full_access(async_client, admin_token):
    ...
    # Given: Admin user (using admin_token fixture)
...
@pytest.mark.asyncio
async def test_1_2_ai_agent_limited_access(async_client, agent_token):
    """Test 1.2: AI Agent Limited Access - Gets limited record."""
    # Given: AI Agent (using agent_token fixture)
...
@pytest.mark.asyncio
async def test_1_3_ai_agent_denied_compensation(async_client, agent_token):
...
async def test_1_4_unauthorized_user_denied(async_client):
    ...
    # We could add an unauthorized_token fixture, but this is fine for now
...
@pytest.mark.asyncio
async def test_1_5_machine_workflow_scoped_access(async_client, monkeypatch, machine_token):
...
@pytest.mark.asyncio
async def test_2_1_machine_triggers_onboarding(async_client, machine_token):
...
@pytest.mark.asyncio
async def test_2_2_ai_agent_denied_flow(async_client, agent_token):
