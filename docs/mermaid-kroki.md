...
1.  **Build Documentation**:
    Generates the static site and processes the diagrams (including C4 patch).
    ```bash
...
**The Fix**:
Run the documentation build script, which includes a patcher for this specific issue:
